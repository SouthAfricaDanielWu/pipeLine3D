...
namespace NorthStar.Pipeline
{
    ...
    *********************************************************************************/
    public partial class CaliberStatist : Form
    {
        ...
        private ArrayList mCaliberStatist = new ArrayList(); //存放长度分段的文本
        public ArrayList GetPipeStatist
        {
            get { return mPipeStatist; }
        }
        public ArrayList GetCaliberStatist
        {
            get { return mCaliberStatist; }
        }
        public CaliberStatist(SceneControl m_SceneControl)
        {
        ...
        private void butStatist_Click(object sender, EventArgs e)
        {
            ...
            {
                mCaliberStatist.Add(this.checkedListBox1.CheckedItems[i].ToString());
            }
            PipeStatist mPipeStatist = new PipeStatist(mLengthStatist, mSceneControl, this, mIndex, mMaterialStatist, mOwnerStatist);
        ...
        private void CaliberStatist_Load(object sender, EventArgs e)
        {
